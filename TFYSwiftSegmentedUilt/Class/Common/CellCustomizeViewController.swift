...
class CellCustomizeViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case "文字渐变":
            //配置数据源
            let dataSource = TFYSwiftTitleGradientDataSource()
            dataSource.isTitleColorGradientEnabled = true
            dataSource.titleSelectedColor = UIColor.red
            dataSource.titles = titles
            vc.segmentedDataSource = dataSource
        ...
        case "数字":
            //配置数据源
            let dataSource = TFYSwiftNumberDataSource()
            dataSource.isTitleColorGradientEnabled = true
            dataSource.titles = titles
...
//            dataSource.numberFont = .systemFont(ofSize: 15)
        ...
        case "文字或者图片":
            //配置数据源
            let dataSource = TFYSwiftTitleOrImageDataSource()
            dataSource.isTitleColorGradientEnabled = true
            dataSource.titleSelectedColor = UIColor.red
            dataSource.isTitleZoomEnabled = true
            dataSource.titleSelectedZoomScale = 1.3
        ...
        case "多行富文本":
            //配置数据源
            let dataSource = TFYSwiftTitleAttributeDataSource()
            ...
            vc.segmentedView.indicators = [indicator]
        case "多种cell":
            let dataSource = TFYSwiftMixcellDataSource()
            vc.segmentedDataSource = dataSource
