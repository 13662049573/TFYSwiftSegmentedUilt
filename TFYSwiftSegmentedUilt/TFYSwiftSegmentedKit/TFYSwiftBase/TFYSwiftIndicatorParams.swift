 ...
 */
public struct TFYSwiftIndicatorSelectedParams {
    public let currentSelectedIndex: Int
    public let currentSelectedItemFrame: CGRect
    public let selectedType: TFYSwiftViewItemSelectedType
    public let currentItemContentWidth: CGFloat
    /// collectionView的contentSize
    public var collectionViewContentSize: CGSize?

    public init(currentSelectedIndex: Int, currentSelectedItemFrame: CGRect, selectedType: TFYSwiftViewItemSelectedType, currentItemContentWidth: CGFloat, collectionViewContentSize: CGSize?) {
...
public struct TFYSwiftIndicatorTransitionParams {
    public let currentSelectedIndex: Int
