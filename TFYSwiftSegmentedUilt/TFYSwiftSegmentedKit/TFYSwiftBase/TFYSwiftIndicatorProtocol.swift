//
//  TFYSwiftIndicatorProtocol.swift
...
public protocol TFYSwiftIndicatorProtocol: UIView {
    ...
    func refreshIndicatorState(model: TFYSwiftIndicatorSelectedParams)
    ...
    /// param percent 过渡百分比
    /// - Parameter model: model description
    func contentScrollViewDidScroll(model: TFYSwiftIndicatorTransitionParams)
